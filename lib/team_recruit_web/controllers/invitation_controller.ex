defmodule TeamRecruitWeb.InvitationController do
  use TeamRecruitWeb, :controller

  alias TeamRecruit.TeamManager
  alias TeamRecruit.Notifications
  alias TeamRecruit.Notifications.Invitation
  ...
  def create(%{assigns: %{user: user}} = conn, params) do
    ...
    with {:ok, %Invitation{} = invitation} <- Notifications.create_invitation(params) do
      TeamRecruitWeb.Endpoint.broadcast!(
